...
class WhatsApp(object):
    ...
    def send_reaction(self, emoji, message_id, recipient_id, recipient_type="individual"):
        """
    ...
    def send_image(self, image, recipient_id, recipient_type="individual", caption=None, link=True):
        """
    ...
    def send_video(self, video, recipient_id, caption=None, link=True) -> Dict[Any, Any]:
        """ 
    ...
    def send_document(self, document, recipient_id, caption=None, link=True) -> Dict[Any, Any]:
        """ "
    ...
    def send_contacts(self, contacts: List[Dict[Any, Any]], recipient_id: str) -> Dict[Any, Any]:
        """send_contacts
    ...
    def download_media(self, media_url: str, mime_type: str, file_path: str = "temp") -> Union[str, None]:
        """
